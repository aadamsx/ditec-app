...
describe('routing tests', function() {
  ...
  it('the page selector switches pages', async function() {
    ...
    await page.waitForSelector('ditec-cmartbook', {visible: true});

    await testNavigation(page, 'services', 'Services');
    await testNavigation(page, 'products', 'View Three');
  ...
  it('the page selector switches pages in a different way', async function() {
    ...
    await testNavigationInADifferentWay(page, 'services', 'Services');
    await testNavigationInADifferentWay(page, 'products', 'View Three');
...
async function testNavigation(page, href, linkText) {
  ...
  const myApp = await page.$('ditec-cmartbook');
...
async function testNavigationInADifferentWay(page, href, linkText) {
  const query = `ditec-cmartbook::shadow a[href="/${href}"]`;
